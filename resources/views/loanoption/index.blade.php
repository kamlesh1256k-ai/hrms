    ...
    <div class="row">
        ...
        <div class="col-12">
            <ul class="nav nav-tabs mb-3" id="addressMasterTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#list-pane" type="button" role="tab">{{ __('Loan Options') }}</button></li>
                                    ...
                                    <tbody>
                                        @foreach ($loanoptions as $loanoption)
                                            <tr>
                                                ...
                                                <td>{{ $masterData['countryNames'][$loanoption->country] ?? ($loanoption->country ?? '—') }}</td>
                                                <td>{{ $masterData['stateNames'][$loanoption->state] ?? ($loanoption->state ?? '—') }}</td>
                                                <td>{{ $masterData['cityNames'][$loanoption->city] ?? ($loanoption->city ?? '—') }}</td>
                                                <td class="Action">
