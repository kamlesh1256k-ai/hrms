...
@section('content')
    <style>
        ...
        .custom-login .bg-login.bg-primary { background: linear-gradient(135deg, #1e3a8a 0%, #1d4ed8 45%, #2563eb 100%) !important; }
        .custom-login .login-bg-1 { content: url("{{ asset('assets/images/theme-4-yellow.svg') }}") !important; }
        .custom-login-form .btn-primary,
        .custom-login-form .btn-primary:hover,
        .custom-login-form .btn-primary:focus,
