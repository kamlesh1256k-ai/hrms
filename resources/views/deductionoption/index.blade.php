...
<div class="row">
        ...
        <div class="col-12">
            <ul class="nav nav-tabs mb-3" id="addressMasterTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#list-pane" type="button" role="tab">{{ __('Deduction Options') }}</button></li>
                                ...
                                <tbody>
                                    @foreach ($deductionoptions as $deductionoption)
                                        <tr>
                                            ...
                                            <td>{{ $masterData['countryNames'][$deductionoption->country] ?? ($deductionoption->country ?? '—') }}</td>
                                            <td>{{ $masterData['stateNames'][$deductionoption->state] ?? ($deductionoption->state ?? '—') }}</td>
                                            <td>{{ $masterData['cityNames'][$deductionoption->city] ?? ($deductionoption->city ?? '—') }}</td>
                                            <td class="Action">
