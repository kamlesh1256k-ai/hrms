    ...
    <div class="row">
        ...
        <div class="col-12">
            <ul class="nav nav-tabs mb-3" id="addressMasterTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#list-pane" type="button" role="tab">{{ __('Goal Types') }}</button></li>
                                ...
                                <table class="table" id="pc-dt-simple">
                                    ...
                                    <tbody>
                                        @foreach ($goaltypes as $goaltype)
                                            <tr>
                                                <td>{{ $goaltype->name }}</td>
                                                <td>{{ $masterData['countryNames'][$goaltype->country] ?? ($goaltype->country ?? '—') }}</td>
                                                <td>{{ $masterData['stateNames'][$goaltype->state] ?? ($goaltype->state ?? '—') }}</td>
                                                <td>{{ $masterData['cityNames'][$goaltype->city] ?? ($goaltype->city ?? '—') }}</td>
                                                <td class="Action">
