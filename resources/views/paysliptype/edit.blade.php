{{ Form::model($paysliptype, ['route' => ['paysliptype.update', $paysliptype->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate', 'data-addr-country' => $paysliptype->country ?? '', 'data-addr-state' => $paysliptype->state ?? '', 'data-addr-city' => $paysliptype->city ?? '']) }}
