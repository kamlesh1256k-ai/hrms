...
@push('css-page')
    ...
    <style>
        /* Compact kanban — fits more candidates per screen, less scrolling */
        .kanban-wrapper > .col { min-width: 240px; max-width: 280px; padding-left: 6px; padding-right: 6px; }
        .kanban-wrapper > .col > .card { margin-bottom: 0; }
        .kanban-wrapper > .col > .card > .card-header { padding: 8px 12px; }
        .kanban-wrapper > .col > .card > .card-header h4 { font-size: .85rem; font-weight: 600; }
        .kanban-wrapper > .col > .card > .card-header .count {
            min-width: 26px; height: 22px; padding: 0 7px; font-size: .72rem; line-height: 22px;
        }
        .kanban-box { padding: 8px !important; min-height: 200px; }
        .kanban-box > .card { margin-bottom: 6px; box-shadow: 0 1px 3px rgba(0,0,0,.06); }
        .kanban-box > .card > .pt-3 { padding-top: 0 !important; padding-left: 0 !important; }
        .kanban-box > .card > .card-header { padding: 8px 10px 4px !important; }
        .kanban-box > .card > .card-header h5 { font-size: .82rem; font-weight: 600; margin: 0; }
        .kanban-box > .card > .card-header h5 a { color: inherit; }
        .kanban-box > .card > .card-header .btn { padding: 2px 6px; font-size: .8rem; }
        .kanban-box > .card > .card-body { padding: 4px 10px 8px !important; }
        .kanban-box > .card .static-rating .star { font-size: .68rem; }
        .kanban-box > .card small.text-md { font-size: .68rem; color: #6c757d; }
        .kanban-box > .card .list-inline-item { font-size: .68rem; color: #6c757d; }
        .kanban-box > .card .list-inline-item .ti { font-size: .8rem; }
        .kanban-box > .card .avatar-group img { width: 22px !important; height: 22px !important; }
        .kanban-wrapper { padding-bottom: 4px; }
        /* Filter card on top — make it tighter so kanban gets more vertical space */
        .container-fluid > .card:first-of-type .card-body { padding: 12px 16px; }
    </style>
@endpush
