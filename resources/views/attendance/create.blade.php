{{ Form::open(['url' => 'attendanceemployee', 'method' => 'post', 'class' => 'needs-validation', 'files' => true, 'novalidate']) }}
<div class="card-body p-0">
    <div class="row">
        ...
        <div class="form-group col-12">
            {{ Form::label('photo', __('Clock-in photo (required)'), ['class' => 'col-form-label']) }}
            <input type="file" name="photo" class="form-control" accept="image/*" required>
            <small class="text-muted">{{ __('Attendance will not be saved without a valid photo.') }}</small>
        </div>
    </div>
</div>
