@php
    $attachmentBaseUrl = \App\Models\Utility::get_file(config('chatify.attachments.folder'));
@endphp
                ...
                <div>
                    <div class="message-card">
                        <div class="image-file chat-image"
                            data-image="{{ $attachmentBaseUrl . '/' . $attachment[0] }}"
                            style="width: 250px; height: 150px;background-image: url('{{ $attachmentBaseUrl . '/' . $attachment[0] }}')">
                        </div>
                    </div>
                </div>
            @endif
        ...
        @if (@$attachment[2] == 'image')
            <div>
                <div class="message-card mc-sender">
                    <div class="image-file chat-image"
                        data-image="{{ \App\Models\Utility::get_file(config('chatify.attachments.folder').'/'.$attachment[0]) }}"
