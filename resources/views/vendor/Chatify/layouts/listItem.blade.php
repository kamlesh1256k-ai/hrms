    ...
    <table class="messenger-list-item m-li-divider" data-contact="{{ Auth::user()->id }}">
        <tr data-action="0">
            ...
            <td style="position: relative" width="100%">
                <p data-id="{{ Auth::user()->id }}" data-type="user" style="text-align: start">Saved Messages
                    <span>You</span>
                </p>
    ...
    <table class="messenger-list-item" data-contact="{{ $user->id }}">
        <tr data-action="0">
            ...
            <td style="position: relative">
                ...
                @endif
                @if (!empty($user->avatar))
                    <div class="avatar av-m" style="background-image: url('{{ $profile . '/' . $user->avatar }}');">
                    </div>
                @else
                    <div class="avatar av-m" style="background-image: url('{{ $profile . '/avatar.png' }}');">
                    </div>
                @endif
            </td>
            {{-- center side --}}
