        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var deptHtml = '<select class="department_id form-control" id="dept-select-cal" multiple required name="department_id[]">';
                    deptHtml += '<option value="">{{ __('Select Department') }}</option>';
                    $.each(data, function(key, value) {
                        deptHtml += '<option value="' + key + '">' + value + '</option>';
                    });
                    deptHtml += '</select>';
                    $('.department_div').html(deptHtml);
