...
<div class="row">
        ...
        <div class="col-12">
            <ul class="nav nav-tabs mb-3" id="addressMasterTabs" role="tablist">
                <li class="nav-item"><button class="nav-link active" data-bs-toggle="tab" data-bs-target="#list-pane" type="button" role="tab">{{ __('Document Types') }}</button></li>
                                ...
                                <tbody>
                                    @foreach ($documents as $document)
                                        <tr>
                                            ...
                                            <td>{{ $masterData['countryNames'][$document->country] ?? ($document->country ?? '—') }}</td>
                                            <td>{{ $masterData['stateNames'][$document->state] ?? ($document->state ?? '—') }}</td>
                                            <td>{{ $masterData['cityNames'][$document->city] ?? ($document->city ?? '—') }}</td>
                                            <td class="Action">
