...
<!-- [ Header ] End -->
<!-- [ common banner ] start -->
<section class="common-banner bg-primary custom-page-banner">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="title">
                    <span class="custom-page-kicker text-uppercase d-inline-block mb-2">{{ __('About Our Company') }}</span>
                    <h1 class="text-white">{!! $page['menubar_page_name'] !!}</h1>
                    <p class="text-white-50 mb-0 custom-page-subtitle">{{ __('Built to simplify people operations with a reliable, scalable, and human-first HR experience.') }}</p>
                </div>
            </div>
            <div class="col-lg-4 d-none d-lg-block">
                <div class="custom-page-banner-badge">
                    <h6 class="mb-2 text-white">{{ __('Trusted HRMS') }}</h6>
                    <p class="mb-0 text-white-50">{{ __('Modern workflows, attendance automation, and smart employee management in one place.') }}</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="static-content section-gap custom-page-content">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10">
                <div class="custom-page-card mb-5">
                    {!! $page['menubar_page_contant'] !!}
                </div>

                <div class="custom-page-cta mb-5">
                    <h3 class="mb-2">{{ __('Ready to transform your HR operations?') }}</h3>
                    <p class="mb-0">{{ __('Explore the platform and see how your team can work smarter with a cleaner, faster, and more intuitive HRMS experience.') }}</p>
                    <div class="d-flex flex-wrap gap-2 mt-4">
                        <a href="{{ route('login') }}" class="btn btn-primary">{{ __('Get Started') }}</a>
                        <a href="../#home" class="btn btn-outline-dark">{{ __('Back to Home') }}</a>
                        @if (isset($adminSettings['disable_signup_button']) && $adminSettings['disable_signup_button'] == 'on')
                            <a href="{{ route('register') }}" class="btn btn-outline-dark">{{ __('Create Account') }}</a>
                        @endif
                    </div>
                </div>
            </div>
