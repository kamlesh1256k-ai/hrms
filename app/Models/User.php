...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public static function defaultEmail()
    {
        ...
        $emailTemplate = [
            ...
            'Contract',
            'New Leave Request',
            'Growth Review Initiation',
            'Growth Review Followup',
            'Growth Review Closed',
            'Growth Review KRA Added',
            'Growth Review Self Rating',
            'Growth Review Manager Rating',
            'Growth Review HOD Rating',
            'Growth Review Management Rating',
        ];
    ...
    public function screenMonitors()
    {
        return $this->hasMany(ScreenMonitor::class, 'user_id');
    }

    public function backgroundScreenshots()
    {
        return $this->hasMany(BackgroundScreenshot::class, 'user_id');
    }
