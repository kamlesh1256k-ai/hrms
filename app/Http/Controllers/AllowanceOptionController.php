...
class AllowanceOptionController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Allowance Option'))
        {
            ...
            return view('allowanceoption.index', compact('allowanceoptions', 'masterData'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Allowance Option'))
        {
            ...
            $allowanceoption->country    = $request->input('country');
            $allowanceoption->state      = $request->input('state');
            $allowanceoption->city       = $request->input('city');
