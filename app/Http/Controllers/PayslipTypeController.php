...
class PayslipTypeController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Payslip Type'))
        {
            ...
            return view('paysliptype.index', compact('paysliptypes', 'masterData'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('Create Payslip Type'))
        {
            ...
            $paysliptype->country    = $request->input('country');
            $paysliptype->state      = $request->input('state');
            $paysliptype->city       = $request->input('city');
