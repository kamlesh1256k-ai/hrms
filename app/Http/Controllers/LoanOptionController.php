...
class LoanOptionController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Loan Option'))
        {
            ...
            return view('loanoption.index', compact('loanoptions', 'masterData'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Loan Option'))
        {
            ...
            $loanoption->country   = $request->input('country');
            $loanoption->state     = $request->input('state');
            $loanoption->city      = $request->input('city');
