...
class DeductionOptionController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Deduction Option'))
        {
            ...
            return view('deductionoption.index', compact('deductionoptions', 'masterData'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Deduction Option'))
        {
            ...
            $deductionoption->country    = $request->input('country');
            $deductionoption->state      = $request->input('state');
            $deductionoption->city       = $request->input('city');
