...
class GoalTypeController extends Controller
{
    ...
    public function index()
    {
        if(\Auth::user()->can('Manage Goal Type'))
        {
            ...
            return view('goaltype.index', compact('goaltypes', 'masterData'));
        }
        else
        {
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Goal Type'))
        {
            ...
            $goaltype->country    = $request->input('country');
            $goaltype->state      = $request->input('state');
            $goaltype->city       = $request->input('city');
